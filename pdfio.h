...
extern pdfio_file_t	*pdfioMemBufOpen(char *ptr, size_t len, pdfio_password_cb_t password_cb, void *password_data, pdfio_error_cb_t error_cb, void *error_data) _PDFIO_PUBLIC;
